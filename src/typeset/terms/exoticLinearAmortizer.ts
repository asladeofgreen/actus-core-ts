 ...
 *
 */
export class TermsetOfExoticLinearAmortizer {
    // Contract Identifier.
    contractID: string;
    ...
    contractType: ContractType = ContractType.LAX;

    // Accrued Interest.
    accruedInterest?: number;

    // Array Cycle Anchor Date Of Interest Payment.
    arrayCycleAnchorDateOfInterestPayment?: typing.List[Date];

    // Array Cycle Anchor Date Of Principal Redemption.
    arrayCycleAnchorDateOfPrincipalRedemption?: typing.List[Date];

    // Array Cycle Anchor Date Of Rate Reset.
    arrayCycleAnchorDateOfRateReset?: typing.List[Date];

    // Array Cycle Of Interest Payment.
    arrayCycleOfInterestPayment?: typing.List[auxiliary.Cycle];

    // Array Cycle Of Principal Redemption.
    arrayCycleOfPrincipalRedemption?: typing.List[auxiliary.Cycle];

    // Array Cycle Of Rate Reset.
    arrayCycleOfRateReset?: typing.List[auxiliary.Cycle];

    // Array Fixed Variable.
    arrayFixedVariable?: typing.List[enums.ArrayFixedVariable];

    // Array Increase Decrease.
    arrayIncreaseDecrease?: typing.List[enums.ArrayIncreaseDecrease];

    // Array Next Principal Redemption Payment.
    arrayNextPrincipalRedemptionPayment?: typing.List[number];

    // Array Rate.
    arrayRate?: typing.List[number];
